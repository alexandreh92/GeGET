...
namespace GeGET
{
    public partial class MovimentoSaida : UserControl, IDisposable
    {
        #region Declarations
        bool disposed = false;
        Helpers helpers = new Helpers();
        MovimentoSaidaBLL bll = new MovimentoSaidaBLL();
        WaitBox wb;
        ObservableCollection<MovimentoSaidaDTO> listaSaldo = new ObservableCollection<MovimentoSaidaDTO>();
        ObservableCollection<MovimentoSaidaDTO> listaExcluir;
        #endregion

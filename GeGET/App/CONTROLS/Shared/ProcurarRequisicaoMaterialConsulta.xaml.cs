...
namespace GeGET
{
    public partial class ProcurarRequisicaoMaterialConsulta : Window, IDisposable
    {
        #region Declarations
        bool disposed = false;
        ...
        #region Initialize
        public ProcurarRequisicaoMaterialConsulta(Point mouseLocation)
        {
            InitializeComponent();

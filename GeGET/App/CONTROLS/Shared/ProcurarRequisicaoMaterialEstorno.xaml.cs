...
namespace GeGET
{
    public partial class ProcurarRequisicaoMaterialEstorno : Window, IDisposable
    {
        #region Declarations
        bool disposed = false;
        ...
        #region Initialize
        public ProcurarRequisicaoMaterialEstorno(Point mouseLocation)
        {
            InitializeComponent();
